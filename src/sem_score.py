...
if __name__ == "__main__":
    ...
    ds = load_dataset('LLMsForHepth/infer_hep-ph_gr-qc', split='test')
    y_true = ds['abstract']
    ...
    scorer = SemsScore(batch_size=2500)  # 2500 fits on 80Gb H100 GPU
    ...
    ds.push_to_hub('paulrichmond/sem_scores_hep-ph_gr-qc', split='test')
